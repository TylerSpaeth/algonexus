...
-- -----------------------------------------------------
-- Table `algonexus`.`assettypes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `algonexus`.`assettypes` (
...
CREATE TABLE IF NOT EXISTS `algonexus`.`symbols` (
  ...
  `BaseCurrency` VARCHAR(3) NULL DEFAULT NULL,
  `QuoteCurrency` VARCHAR(3) NULL DEFAULT NULL,
  `ContractCode` VARCHAR(10) NULL DEFAULT NULL,
  `ExpirationDate` DATE NULL DEFAULT NULL,
  PRIMARY KEY (`SymbolID`),
  INDEX `AssetTypeID_idx` (`AssetTypeID` ASC) VISIBLE,
  INDEX `ExchangeID_idx` (`ExchangeID` ASC) VISIBLE,
  CONSTRAINT `fk_symbols_assettypes_AssetTypeID`
    FOREIGN KEY (`AssetTypeID`)
    REFERENCES `algonexus`.`assettypes` (`AssetTypeID`),
